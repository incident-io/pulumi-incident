 ...
 * ## Upgrading from v6
 *
 * Before v7, a rotation was declared inline on `incident.Schedule`, in its
 * `rotations` attribute. It is now its own resource. See `incident.Schedule`
...
export class ScheduleRotation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'incident:index/scheduleRotation:ScheduleRotation';
     ...
     */
    declare public readonly handovers: pulumi.Output<outputs.ScheduleRotationHandover[]>;
    /**
     ...
     */
    declare public readonly workingIntervals: pulumi.Output<outputs.ScheduleRotationWorkingInterval[] | undefined>;
...
export interface ScheduleRotationState {
     ...
     * The cadence shifts hand over on, applied in turn
     */
    handovers?: pulumi.Input<pulumi.Input<inputs.ScheduleRotationHandover>[] | undefined>;
    /**
     * Human readable name for the rotation, unique within the schedule
     */
     ...
     * If set, restricts on-call to these weekday intervals. Omit it to keep the rotation on call around the clock. An empty list is not valid, and is rejected at plan time — it would leave a rotation nobody is ever on call for.
     */
    workingIntervals?: pulumi.Input<pulumi.Input<inputs.ScheduleRotationWorkingInterval>[] | undefined>;
}
...
export interface ScheduleRotationArgs {
     ...
     * The cadence shifts hand over on, applied in turn
     */
    handovers: pulumi.Input<pulumi.Input<inputs.ScheduleRotationHandover>[]>;
    /**
     * Human readable name for the rotation, unique within the schedule
     */
    name?: pulumi.Input<string | undefined>;
