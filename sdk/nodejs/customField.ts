...
export class CustomField extends pulumi.CustomResource {
     ...
     */
    declare public readonly fixedFilter: pulumi.Output<outputs.CustomFieldFixedFilter | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CustomFieldArgs | CustomFieldState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["fixedFilter"] = state?.fixedFilter;
            ...
            resourceInputs["fixedFilter"] = args?.fixedFilter;
...
export interface CustomFieldState {
     ...
     * Restrict this catalog-backed field's options to catalog entries whose `catalogAttributeId` attribute references one of `values`. This is the static counterpart to `filterBy`: rather than following whatever another custom field is set to on the incident, the filter is chosen up front and is the same for every incident. Mutually exclusive with `filterBy`.
     */
    fixedFilter?: pulumi.Input<inputs.CustomFieldFixedFilter | undefined>;
    /**
     * For catalog fields, the ID of the attribute used to group catalog entries (if applicable)
     */
