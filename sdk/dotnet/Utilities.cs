...
namespace IncidentIO.Incident
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/incident-io/pulumi-incident";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("IncidentIO.Incident.version.txt");
    ...
    internal sealed class IncidentResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public IncidentResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
