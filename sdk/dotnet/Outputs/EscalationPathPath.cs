...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class EscalationPathPath
    {
        public readonly Outputs.EscalationPathPathDelay? Delay;
        /// <summary>
        /// Reassign the escalation to another escalation path, continuing from that path's first node.
        /// </summary>
        public readonly Outputs.EscalationPathPathEscalationPath? EscalationPath;
        /// <summary>
        ...
        public readonly Outputs.EscalationPathPathIfElse? IfElse;
        public readonly Outputs.EscalationPathPathLevel? Level;
        public readonly Outputs.EscalationPathPathNotifyChannel? NotifyChannel;
        public readonly Outputs.EscalationPathPathRepeat? Repeat;
        /// <summary>
        ...
        [OutputConstructor]
        private EscalationPathPath(
            Outputs.EscalationPathPathDelay? delay,

            Outputs.EscalationPathPathEscalationPath? escalationPath,

            string? id,

            Outputs.EscalationPathPathIfElse? ifElse,

            Outputs.EscalationPathPathLevel? level,

            Outputs.EscalationPathPathNotifyChannel? notifyChannel,

            Outputs.EscalationPathPathRepeat? repeat,
