...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class EscalationPathPathIfElseThenPathIfElseThenPathIfElseThenPathIfElseElsePathLevelRetryConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private EscalationPathPathIfElseThenPathIfElseThenPathIfElseThenPathIfElseElsePathLevelRetryConfig(
            int attempts,
