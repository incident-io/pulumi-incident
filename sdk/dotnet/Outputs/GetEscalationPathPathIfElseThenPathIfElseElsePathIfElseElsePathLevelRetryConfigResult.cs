...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class GetEscalationPathPathIfElseThenPathIfElseElsePathIfElseElsePathLevelRetryConfigResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetEscalationPathPathIfElseThenPathIfElseElsePathIfElseElsePathLevelRetryConfigResult(
            int attempts,
