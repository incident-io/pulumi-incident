...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class GetEscalationPathPathIfElseThenPathIfElseThenPathIfElseElsePathLevelRetryConfigResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetEscalationPathPathIfElseThenPathIfElseThenPathIfElseElsePathLevelRetryConfigResult(
            int attempts,
