...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class EscalationPathPathIfElseThenPathIfElseThenPathLevelRetryConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private EscalationPathPathIfElseThenPathIfElseThenPathLevelRetryConfig(
            int attempts,
