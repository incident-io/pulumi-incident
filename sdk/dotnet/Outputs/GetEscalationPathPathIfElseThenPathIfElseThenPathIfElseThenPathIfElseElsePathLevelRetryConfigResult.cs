...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class GetEscalationPathPathIfElseThenPathIfElseThenPathIfElseThenPathIfElseElsePathLevelRetryConfigResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetEscalationPathPathIfElseThenPathIfElseThenPathIfElseThenPathIfElseElsePathLevelRetryConfigResult(
            int attempts,
