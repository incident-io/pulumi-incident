...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class EscalationPathPathIfElseElsePathIfElseElsePathIfElseElsePathLevelRetryConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private EscalationPathPathIfElseElsePathIfElseElsePathIfElseElsePathLevelRetryConfig(
            int attempts,
