...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class EscalationPathPathIfElseThenPathIfElseElsePathIfElseElsePathIfElseThenPathLevelRetryConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private EscalationPathPathIfElseThenPathIfElseElsePathIfElseElsePathIfElseThenPathLevelRetryConfig(
            int attempts,
