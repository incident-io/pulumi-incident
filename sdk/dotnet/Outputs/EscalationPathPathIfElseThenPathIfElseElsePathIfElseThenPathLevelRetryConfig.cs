...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class EscalationPathPathIfElseThenPathIfElseElsePathIfElseThenPathLevelRetryConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private EscalationPathPathIfElseThenPathIfElseElsePathIfElseThenPathLevelRetryConfig(
            int attempts,
