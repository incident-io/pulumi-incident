...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class GetEscalationPathPathIfElseElsePathIfElseElsePathIfElseThenPathLevelRetryConfigResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetEscalationPathPathIfElseElsePathIfElseElsePathIfElseThenPathLevelRetryConfigResult(
            int attempts,
