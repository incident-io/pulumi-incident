...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class EscalationPathPathIfElseElsePathIfElseElsePathIfElseThenPathIfElseThenPathLevelRetryConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private EscalationPathPathIfElseElsePathIfElseElsePathIfElseThenPathIfElseThenPathLevelRetryConfig(
            int attempts,
