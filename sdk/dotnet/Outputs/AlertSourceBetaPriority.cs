...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class AlertSourceBetaPriority
    {
        /// <summary>
        /// Several values, spelled out. Needed when they mix fixed values and references.
        /// </summary>
        public readonly ImmutableArray<Outputs.AlertSourceBetaPriorityArrayValue> ArrayValues;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.AlertSourceBetaPriorityValue? Value;
        /// <summary>
        ...
        [OutputConstructor]
        private AlertSourceBetaPriority(
            ImmutableArray<Outputs.AlertSourceBetaPriorityArrayValue> arrayValues,

            string? expressionRef,

            Outputs.AlertSourceBetaPriorityValue? value,
