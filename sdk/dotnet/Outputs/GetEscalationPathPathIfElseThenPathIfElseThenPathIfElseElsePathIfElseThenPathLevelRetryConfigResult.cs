...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class GetEscalationPathPathIfElseThenPathIfElseThenPathIfElseElsePathIfElseThenPathLevelRetryConfigResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetEscalationPathPathIfElseThenPathIfElseThenPathIfElseElsePathIfElseThenPathLevelRetryConfigResult(
            int attempts,
