...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class GetEscalationPathPathIfElseThenPathIfElseElsePathIfElseThenPathLevelTargetResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetEscalationPathPathIfElseThenPathIfElseElsePathIfElseThenPathLevelTargetResult(
            string id,
