...
namespace IncidentIO.Incident.Outputs
{
    ...
    [OutputType]
    public sealed class EscalationPathPathIfElseElsePathIfElseThenPathIfElseElsePathLevelRetryConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private EscalationPathPathIfElseElsePathIfElseThenPathIfElseElsePathLevelRetryConfig(
            int attempts,
