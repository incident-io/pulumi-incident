...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class EscalationPathPathIfElseElsePathGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("delay")]
        public Input<Inputs.EscalationPathPathIfElseElsePathDelayGetArgs>? Delay { get; set; }

        /// <summary>
        /// Reassign the escalation to another escalation path, continuing from that path's first node.
        /// </summary>
        [Input("escalationPath")]
        public Input<Inputs.EscalationPathPathIfElseElsePathEscalationPathGetArgs>? EscalationPath { get; set; }
        ...
        [Input("ifElse")]
        public Input<Inputs.EscalationPathPathIfElseElsePathIfElseGetArgs>? IfElse { get; set; }

        [Input("level")]
        public Input<Inputs.EscalationPathPathIfElseElsePathLevelGetArgs>? Level { get; set; }

        [Input("notifyChannel")]
        public Input<Inputs.EscalationPathPathIfElseElsePathNotifyChannelGetArgs>? NotifyChannel { get; set; }

        [Input("repeat")]
        public Input<Inputs.EscalationPathPathIfElseElsePathRepeatGetArgs>? Repeat { get; set; }
        ...
        public EscalationPathPathIfElseElsePathGetArgs()
        {
        }
        public static new EscalationPathPathIfElseElsePathGetArgs Empty => new EscalationPathPathIfElseElsePathGetArgs();
    }
}
