...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class EscalationPathPathGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("delay")]
        public Input<Inputs.EscalationPathPathDelayGetArgs>? Delay { get; set; }

        /// <summary>
        /// Reassign the escalation to another escalation path, continuing from that path's first node.
        /// </summary>
        [Input("escalationPath")]
        public Input<Inputs.EscalationPathPathEscalationPathGetArgs>? EscalationPath { get; set; }
        ...
        [Input("ifElse")]
        public Input<Inputs.EscalationPathPathIfElseGetArgs>? IfElse { get; set; }

        [Input("level")]
        public Input<Inputs.EscalationPathPathLevelGetArgs>? Level { get; set; }

        [Input("notifyChannel")]
        public Input<Inputs.EscalationPathPathNotifyChannelGetArgs>? NotifyChannel { get; set; }

        [Input("repeat")]
        public Input<Inputs.EscalationPathPathRepeatGetArgs>? Repeat { get; set; }
        ...
        public EscalationPathPathGetArgs()
        {
        }
        public static new EscalationPathPathGetArgs Empty => new EscalationPathPathGetArgs();
    }
}
