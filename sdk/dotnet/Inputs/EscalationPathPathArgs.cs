...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class EscalationPathPathArgs : global::Pulumi.ResourceArgs
    {
        [Input("delay")]
        public Input<Inputs.EscalationPathPathDelayArgs>? Delay { get; set; }

        /// <summary>
        /// Reassign the escalation to another escalation path, continuing from that path's first node.
        /// </summary>
        [Input("escalationPath")]
        public Input<Inputs.EscalationPathPathEscalationPathArgs>? EscalationPath { get; set; }
        ...
        [Input("ifElse")]
        public Input<Inputs.EscalationPathPathIfElseArgs>? IfElse { get; set; }

        [Input("level")]
        public Input<Inputs.EscalationPathPathLevelArgs>? Level { get; set; }

        [Input("notifyChannel")]
        public Input<Inputs.EscalationPathPathNotifyChannelArgs>? NotifyChannel { get; set; }

        [Input("repeat")]
        public Input<Inputs.EscalationPathPathRepeatArgs>? Repeat { get; set; }
        ...
        public EscalationPathPathArgs()
        {
        }
        public static new EscalationPathPathArgs Empty => new EscalationPathPathArgs();
    }
}
