...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class AlertSourceTemplateExpressionOperationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An operation type that allows for a value to be set conditionally by a series of logical branches
        /// </summary>
        [Input("branches")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationBranchesArgs>? Branches { get; set; }
        ...
        /// </summary>
        [Input("cast")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationCastArgs>? Cast { get; set; }
        ...
        /// </summary>
        [Input("concatenate")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationConcatenateArgs>? Concatenate { get; set; }

        /// <summary>
        /// An operation type that allows values to be filtered out by conditions
        /// </summary>
        [Input("filter")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationFilterArgs>? Filter { get; set; }

        /// <summary>
        /// An operation type that allows attributes of a type to be accessed by reference
        /// </summary>
        [Input("navigate")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationNavigateArgs>? Navigate { get; set; }
        ...
        /// </summary>
        [Input("parse")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationParseArgs>? Parse { get; set; }

        public AlertSourceTemplateExpressionOperationArgs()
        {
        }
        public static new AlertSourceTemplateExpressionOperationArgs Empty => new AlertSourceTemplateExpressionOperationArgs();
    }
}
