...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class WorkflowExpressionOperationGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An operation type that allows for a value to be set conditionally by a series of logical branches
        /// </summary>
        [Input("branches")]
        public Input<Inputs.WorkflowExpressionOperationBranchesGetArgs>? Branches { get; set; }
        ...
        /// </summary>
        [Input("cast")]
        public Input<Inputs.WorkflowExpressionOperationCastGetArgs>? Cast { get; set; }
        ...
        /// </summary>
        [Input("concatenate")]
        public Input<Inputs.WorkflowExpressionOperationConcatenateGetArgs>? Concatenate { get; set; }

        /// <summary>
        /// An operation type that allows values to be filtered out by conditions
        /// </summary>
        [Input("filter")]
        public Input<Inputs.WorkflowExpressionOperationFilterGetArgs>? Filter { get; set; }

        /// <summary>
        /// An operation type that allows attributes of a type to be accessed by reference
        /// </summary>
        [Input("navigate")]
        public Input<Inputs.WorkflowExpressionOperationNavigateGetArgs>? Navigate { get; set; }
        ...
        /// </summary>
        [Input("parse")]
        public Input<Inputs.WorkflowExpressionOperationParseGetArgs>? Parse { get; set; }

        public WorkflowExpressionOperationGetArgs()
        {
        }
        public static new WorkflowExpressionOperationGetArgs Empty => new WorkflowExpressionOperationGetArgs();
    }
}
