...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class EscalationPathPathIfElseElsePathArgs : global::Pulumi.ResourceArgs
    {
        [Input("delay")]
        public Input<Inputs.EscalationPathPathIfElseElsePathDelayArgs>? Delay { get; set; }

        /// <summary>
        /// Reassign the escalation to another escalation path, continuing from that path's first node.
        /// </summary>
        [Input("escalationPath")]
        public Input<Inputs.EscalationPathPathIfElseElsePathEscalationPathArgs>? EscalationPath { get; set; }
        ...
        [Input("ifElse")]
        public Input<Inputs.EscalationPathPathIfElseElsePathIfElseArgs>? IfElse { get; set; }

        [Input("level")]
        public Input<Inputs.EscalationPathPathIfElseElsePathLevelArgs>? Level { get; set; }

        [Input("notifyChannel")]
        public Input<Inputs.EscalationPathPathIfElseElsePathNotifyChannelArgs>? NotifyChannel { get; set; }

        [Input("repeat")]
        public Input<Inputs.EscalationPathPathIfElseElsePathRepeatArgs>? Repeat { get; set; }
        ...
        public EscalationPathPathIfElseElsePathArgs()
        {
        }
        public static new EscalationPathPathIfElseElsePathArgs Empty => new EscalationPathPathIfElseElsePathArgs();
    }
}
