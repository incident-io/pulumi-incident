...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class EscalationPathPathLevelRetryConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public EscalationPathPathLevelRetryConfigGetArgs()
        {
        }
        public static new EscalationPathPathLevelRetryConfigGetArgs Empty => new EscalationPathPathLevelRetryConfigGetArgs();
    }
}
