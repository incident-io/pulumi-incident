...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class AlertSourceTemplateExpressionOperationGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An operation type that allows for a value to be set conditionally by a series of logical branches
        /// </summary>
        [Input("branches")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationBranchesGetArgs>? Branches { get; set; }
        ...
        /// </summary>
        [Input("cast")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationCastGetArgs>? Cast { get; set; }
        ...
        /// </summary>
        [Input("concatenate")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationConcatenateGetArgs>? Concatenate { get; set; }

        /// <summary>
        /// An operation type that allows values to be filtered out by conditions
        /// </summary>
        [Input("filter")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationFilterGetArgs>? Filter { get; set; }

        /// <summary>
        /// An operation type that allows attributes of a type to be accessed by reference
        /// </summary>
        [Input("navigate")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationNavigateGetArgs>? Navigate { get; set; }
        ...
        /// </summary>
        [Input("parse")]
        public Input<Inputs.AlertSourceTemplateExpressionOperationParseGetArgs>? Parse { get; set; }

        public AlertSourceTemplateExpressionOperationGetArgs()
        {
        }
        public static new AlertSourceTemplateExpressionOperationGetArgs Empty => new AlertSourceTemplateExpressionOperationGetArgs();
    }
}
