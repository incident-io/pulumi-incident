...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class EscalationPathPathIfElseThenPathGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("delay")]
        public Input<Inputs.EscalationPathPathIfElseThenPathDelayGetArgs>? Delay { get; set; }

        /// <summary>
        /// Reassign the escalation to another escalation path, continuing from that path's first node.
        /// </summary>
        [Input("escalationPath")]
        public Input<Inputs.EscalationPathPathIfElseThenPathEscalationPathGetArgs>? EscalationPath { get; set; }
        ...
        [Input("ifElse")]
        public Input<Inputs.EscalationPathPathIfElseThenPathIfElseGetArgs>? IfElse { get; set; }

        [Input("level")]
        public Input<Inputs.EscalationPathPathIfElseThenPathLevelGetArgs>? Level { get; set; }

        [Input("notifyChannel")]
        public Input<Inputs.EscalationPathPathIfElseThenPathNotifyChannelGetArgs>? NotifyChannel { get; set; }

        [Input("repeat")]
        public Input<Inputs.EscalationPathPathIfElseThenPathRepeatGetArgs>? Repeat { get; set; }
        ...
        public EscalationPathPathIfElseThenPathGetArgs()
        {
        }
        public static new EscalationPathPathIfElseThenPathGetArgs Empty => new EscalationPathPathIfElseThenPathGetArgs();
    }
}
