...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class EscalationPathPathIfElseThenPathArgs : global::Pulumi.ResourceArgs
    {
        [Input("delay")]
        public Input<Inputs.EscalationPathPathIfElseThenPathDelayArgs>? Delay { get; set; }

        /// <summary>
        /// Reassign the escalation to another escalation path, continuing from that path's first node.
        /// </summary>
        [Input("escalationPath")]
        public Input<Inputs.EscalationPathPathIfElseThenPathEscalationPathArgs>? EscalationPath { get; set; }
        ...
        [Input("ifElse")]
        public Input<Inputs.EscalationPathPathIfElseThenPathIfElseArgs>? IfElse { get; set; }

        [Input("level")]
        public Input<Inputs.EscalationPathPathIfElseThenPathLevelArgs>? Level { get; set; }

        [Input("notifyChannel")]
        public Input<Inputs.EscalationPathPathIfElseThenPathNotifyChannelArgs>? NotifyChannel { get; set; }

        [Input("repeat")]
        public Input<Inputs.EscalationPathPathIfElseThenPathRepeatArgs>? Repeat { get; set; }
        ...
        public EscalationPathPathIfElseThenPathArgs()
        {
        }
        public static new EscalationPathPathIfElseThenPathArgs Empty => new EscalationPathPathIfElseThenPathArgs();
    }
}
