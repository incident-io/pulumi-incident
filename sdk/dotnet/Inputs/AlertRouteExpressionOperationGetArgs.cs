...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class AlertRouteExpressionOperationGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An operation type that allows for a value to be set conditionally by a series of logical branches
        /// </summary>
        [Input("branches")]
        public Input<Inputs.AlertRouteExpressionOperationBranchesGetArgs>? Branches { get; set; }
        ...
        /// </summary>
        [Input("cast")]
        public Input<Inputs.AlertRouteExpressionOperationCastGetArgs>? Cast { get; set; }
        ...
        /// </summary>
        [Input("concatenate")]
        public Input<Inputs.AlertRouteExpressionOperationConcatenateGetArgs>? Concatenate { get; set; }

        /// <summary>
        /// An operation type that allows values to be filtered out by conditions
        /// </summary>
        [Input("filter")]
        public Input<Inputs.AlertRouteExpressionOperationFilterGetArgs>? Filter { get; set; }

        /// <summary>
        /// An operation type that allows attributes of a type to be accessed by reference
        /// </summary>
        [Input("navigate")]
        public Input<Inputs.AlertRouteExpressionOperationNavigateGetArgs>? Navigate { get; set; }
        ...
        /// </summary>
        [Input("parse")]
        public Input<Inputs.AlertRouteExpressionOperationParseGetArgs>? Parse { get; set; }

        public AlertRouteExpressionOperationGetArgs()
        {
        }
        public static new AlertRouteExpressionOperationGetArgs Empty => new AlertRouteExpressionOperationGetArgs();
    }
}
