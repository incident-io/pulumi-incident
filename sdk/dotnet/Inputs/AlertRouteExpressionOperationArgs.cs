...
namespace IncidentIO.Incident.Inputs
{
    ...
    public sealed class AlertRouteExpressionOperationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An operation type that allows for a value to be set conditionally by a series of logical branches
        /// </summary>
        [Input("branches")]
        public Input<Inputs.AlertRouteExpressionOperationBranchesArgs>? Branches { get; set; }
        ...
        /// </summary>
        [Input("cast")]
        public Input<Inputs.AlertRouteExpressionOperationCastArgs>? Cast { get; set; }
        ...
        /// </summary>
        [Input("concatenate")]
        public Input<Inputs.AlertRouteExpressionOperationConcatenateArgs>? Concatenate { get; set; }

        /// <summary>
        /// An operation type that allows values to be filtered out by conditions
        /// </summary>
        [Input("filter")]
        public Input<Inputs.AlertRouteExpressionOperationFilterArgs>? Filter { get; set; }

        /// <summary>
        /// An operation type that allows attributes of a type to be accessed by reference
        /// </summary>
        [Input("navigate")]
        public Input<Inputs.AlertRouteExpressionOperationNavigateArgs>? Navigate { get; set; }
        ...
        /// </summary>
        [Input("parse")]
        public Input<Inputs.AlertRouteExpressionOperationParseArgs>? Parse { get; set; }

        public AlertRouteExpressionOperationArgs()
        {
        }
        public static new AlertRouteExpressionOperationArgs Empty => new AlertRouteExpressionOperationArgs();
    }
}
